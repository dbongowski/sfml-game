...
namespace Bongo
{
	...
	{
	public:
		TextPenguin(int size, int UsedIndex, int PlayerNumber, string PlayerName, GameDataRef data);
		~TextPenguin();
		void LoadText();
		void texttest();
		void AssignText();
	...
	private:
		...
		bool error;
		float position[NUMBER_OF_BLOCKS * 2] = { 25, 180, 225, 180, 425, 180, 625, 180 };
		float PlayerDataPosition[4] = { 710, 20, 20, 20 };
		int Pair[2];
